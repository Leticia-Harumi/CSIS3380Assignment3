...
//'Planet' component that renders a planet card
const Planet = (props) => {
  return (
    <div className="card">
      <div>
...
// App component that iterates over the planets array 
// Renders a Planet component for each element in array 
class App extends React.Component {
  // state stores the planet array
  state = {
    planets: [
      {
        id: '1',
